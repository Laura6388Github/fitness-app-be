...
exports.register = async (req, res, next) => {
  ...
  "
>
<h1 style="color: blueviolet">${process.env.COMPANY_NAME}</h1>
  <div
    style="
      max-width: 500px;
      padding: 20px;
    ...
    "
  >
    <h3>Dear <strong>${user.firstname} ${user.lastname}</strong>,</h3>

    <p>
      Thank you for registering with our fitnest app! We're excited to have you
      as a new member of our community.
    </p>

    <p>To activate your account, please confirm this OTP code.</p>
    <p>This OTP code will expire after 10 mins.</p>
    <div style="width: 100%; display: flex; justify-content: center;">
    <div style="padding: 10px; border: 1px solid grey; width: fit-content; margin: 10px; display: flex;">
      <h1 style="margin: 0; padding-right: 20px;">${otp[0]}</h1>
      <h1 style="margin: 0; padding-right: 20px;">${otp[1]}</h1>
      <h1 style="margin: 0; padding-right: 20px;">${otp[2]}</h1>
      <h1 style="margin: 0">${otp[3]}</h1>
    </div>
</div>
    Once your account is activated, you'll be able to log in to our Fitnest app and
    enjoy all of the benefits of membership and our services.

    <p>
      If you have any questions or concerns, please don't hesitate to reach out
      to our customer support team at
      <strong>${process.env.COMPANY_SUPPORT_EMAIL}</strong> or
      <strong>${process.env.COMPANY_SUPPORT_PHONE}</strong>.
    </p>
